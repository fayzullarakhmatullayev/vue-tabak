<template>
  <div class="relative flex flex-col">
    ...
    <div class="dark:bg-black-900 sticky bottom-16 z-50 h-12 w-full bg-white">
      <div
        class="dark:border-blueish border-black-900 flex h-full items-center justify-start border-y text-sm"
      >
        <div class="flex h-full w-1/2 flex-col items-start justify-center px-1">
          <span>2400 ₽</span>
          <span class="text-black-700 text-xs"
            >{{ products.length }} товар(-ов)</span
          >
        </div>
        <router-link
          to="/checkout-preview"
